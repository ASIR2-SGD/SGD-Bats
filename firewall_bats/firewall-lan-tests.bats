...
@test "00. Check tests running on targeted machine" {
    #ATTENTION: IF THIS TESTS FAILS MIGHT BE BECAUSE YOU ARE RUNNING THE LAN TEST IN THE WRONG MACHINE,
    #RUN IT IN LAN MACHINE INSTEAD
    run hostname
    assert_output 'lan'
}
...
@test "07. Check connection to external should succeed" {        
...
@test "09. Check http connection to dmz should succeed" {        
