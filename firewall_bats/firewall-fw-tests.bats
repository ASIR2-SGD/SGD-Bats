...
@test "01. Check 60-routes.yaml configured" {        
    ...
    asset_line --partial 'via: 192.168.82.100'
}

@test "01. Check default gw is set" {        
    run bats_pipe route -n \| awk 'NR>2{ print $1" "$2" "$8}'
    assert_line  '0.0.0.0 192.168.82.100 eth1'
}
...
##RULES
@test "01. Traffic from loopback interface should succeed" {        
    run ping -c 1 -W 0.2 localhost
    [ "$status" -eq 0 ]
}

@test "01. Output traffic  generated by fw should fail" {        
